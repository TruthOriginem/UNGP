...
import static ungp.scripts.utils.UNGPUtils.EMPTY;
import static ungp.scripts.utils.UNGPUtils.isEmpty;
...
public final class UNGP_RuleInfoLoader {
     ...
     */
    public static List<UNGP_RuleInfo> loadAllRuleInformation() {
