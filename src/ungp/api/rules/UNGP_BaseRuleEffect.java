...
import ungp.scripts.utils.SimpleI18n.I18nSection;
...
public abstract class UNGP_BaseRuleEffect implements UNGP_RuleEffectAPI {
    ...
    /**
     * Called to save ungp.data.
     *
     * @param slot To distinguish the different ungp.data, it's not the *saving slot*.
     * @param t
     * @param <T>
     */
    ...
    /**
     * Called to get the ungp.data, might be null
     *
     * @param slot
     * @param <T>
     * @return
